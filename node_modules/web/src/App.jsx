...
import AssociatePayoutCycles from './modules/finance/pages/AssociatePayoutCycles';
...
import AssociateShareTrack from './modules/marketing/pages/AssociateShareTrack';

// ── Associate module ─────────────────────────────────────────────────────────
import AdminAssociates from './modules/associate/pages/AdminAssociates';
import AssociateLayout from './modules/associate/components/AssociateLayout';
import AssociateDashboard from './modules/associate/pages/AssociateDashboard';
import AssociateServices from './modules/associate/pages/AssociateServices';
import AssociateCommissions from './modules/associate/pages/AssociateCommissions';
import AssociatePayouts from './modules/associate/pages/AssociatePayouts';
import AssociateBank from './modules/associate/pages/AssociateBank';
import AssociateSubAssociates from './modules/associate/pages/AssociateSubAssociates';
import AssociateRewards from './modules/associate/pages/AssociateRewards';
...
const pageTitles = {
  ...
  '/finance/associate-payout-cycles': '💳 Associate Payout Cycles',
...
function LegacyAffiliateRedirect() {
  const location = useLocation();
  const rest = location.pathname.replace(/^\/affiliate\/?/, '');
  const target = rest ? `/associate/${rest}` : '/associate';
      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route path="/finance/payout-cycles" element={
            <ProtectedRoute staffOnly requiredAnyPermissions={['associates.manage', 'partners.manage']}>
              <Layout routePath="/finance/payout-cycles"><PayoutCyclesHub /></Layout>
            </ProtectedRoute>
          } />
          <Route path="/finance/associate-payout-cycles" element={
            <ProtectedRoute staffOnly requiredPermission="associates.manage">
              <Layout routePath="/finance/associate-payout-cycles"><AssociatePayoutCycles /></Layout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/admin/associates" element={
            <ProtectedRoute staffOnly requiredPermission="associates.manage">
              <Layout routePath="/admin/associates">
                <AdminAssociates />
              </Layout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/admin/associate-payout-cycle-amendments" element={<Navigate to="/admin/approvals" replace />} />
          ...
          <Route path="/marketing/associate-tracking" element={<ProtectedRoute staffOnly><Layout routePath="/marketing/associate-tracking"><AssociateShareTrack /></Layout></ProtectedRoute>} />
          ...
          <Route path="/marketing/associate" element={<Navigate to="/admin/associates" replace />} />
          <Route path="/marketing/triggers" element={<Navigate to="/settings" replace />} />

          <Route path="/associate" element={<ProtectedRoute associateOnly><AssociateDashboard /></ProtectedRoute>} />
          <Route path="/associate/services" element={<ProtectedRoute associateOnly><AssociateServices /></ProtectedRoute>} />
          <Route path="/associate/commissions" element={<ProtectedRoute associateOnly><AssociateCommissions /></ProtectedRoute>} />
          <Route path="/associate/payouts" element={<ProtectedRoute associateOnly><AssociatePayouts /></ProtectedRoute>} />
          <Route path="/associate/bank" element={<ProtectedRoute associateOnly><AssociateBank /></ProtectedRoute>} />
          <Route path="/associate/sub-associates" element={<ProtectedRoute associateOnly><AssociateSubAssociates /></ProtectedRoute>} />
          <Route path="/associate/rewards" element={<ProtectedRoute associateOnly><AssociateRewards /></ProtectedRoute>} />
          <Route path="/associate/chat" element={
            <ProtectedRoute associateOnly requiredPermission="chat.use">
              <AssociateLayout title="Team chat">
                <ChatPage auditPath="/associate/chat/audit" />
              </AssociateLayout>
            </ProtectedRoute>
          } />
          <Route path="/associate/chat/audit" element={
            <ProtectedRoute associateOnly requiredPermission="chat.use">
              <AssociateLayout title="Chat audit log">
                <ChatAuditPage backPath="/associate/chat" />
              </AssociateLayout>
            </ProtectedRoute>
          } />
          <Route path="/associate/profile" element={
            <ProtectedRoute associateOnly>
              <AssociateLayout title="My profile">
                <Profile />
              </AssociateLayout>
            </ProtectedRoute>
          } />

          {/* Legacy portal URL redirects (old /affiliate/* bookmarks) */}
          <Route path="/affiliate" element={<Navigate to="/associate" replace />} />
          <Route path="/affiliate/*" element={<LegacyAffiliateRedirect />} />
          <Route path="/admin/affiliates" element={<Navigate to="/admin/associates" replace />} />
          <Route path="/finance/affiliate-payout-cycles" element={<Navigate to="/finance/associate-payout-cycles" replace />} />
          <Route path="/marketing/affiliate-tracking" element={<Navigate to="/marketing/associate-tracking" replace />} />
          <Route path="/marketing/affiliate" element={<Navigate to="/admin/associates" replace />} />
