...
import { getAssociateBankList, postAssociateBank } from '../services/associatePortalService';

export default function AssociateBank() {
  ...
  function load() {
    getAssociateBankList().then(setRows).catch(() => setRows([]));
  }
  ...
  return (
    <AssociateLayout title="Bank details (KYC)">
