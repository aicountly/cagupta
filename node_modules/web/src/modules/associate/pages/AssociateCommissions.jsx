...
import { getAssociateCommissions } from '../services/associatePortalService';

export default function AssociateCommissions() {
  ...
  const load = useCallback(() => {
    setErr('');
    getAssociateCommissions({ dateFrom: from || undefined, dateTo: to || undefined, perPage: 100 })
  ...
  return (
    <AssociateLayout title="Commissions & statements">
