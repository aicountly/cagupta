...
import { postSubAssociate } from '../services/associatePortalService';

export default function AssociateSubAssociates() {
  ...
  async function submit(e) {
    ...
    setOk('');
    try {
      await postSubAssociate({ name, email, password });
  ...
  return (
    <AssociateLayout title="Invite sub-associate">
      <div style={{ background: '#fff', borderRadius: 12, padding: 20, border: '1px solid #e2e8f0', maxWidth: 440 }}>
        <p style={{ fontSize: 13, color: '#64748b', marginTop: 0 }}>
          Create a pending associate account linked to you. They sign in with the email and password you set; staff must approve before they can use the portal.
        </p>
