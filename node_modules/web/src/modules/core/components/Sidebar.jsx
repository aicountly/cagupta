...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/finance/payout-cycles', label: 'Payout Cycles', icon: Wallet, anyOf: ['associates.manage', 'partners.manage'] },
    ],
  },
  {
    label: 'MARKETING',
...
const adminNavItems = [
  ...
  { to: '/admin/associates', label: 'Associates', icon: Handshake, permission: 'associates.manage' },
