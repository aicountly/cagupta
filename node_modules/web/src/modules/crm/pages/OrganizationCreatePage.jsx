...
export default function OrganizationCreatePage() {
  ...
  function buildOrg(f) {
    return {
      ...
      referringAssociateUserId: f.referringAssociateUserId || null,
  ...
  function buildOrgDisplayLabels(org) {
    const secondaryNames = (form.secondaryContactIds || [])
      ...
      .filter(Boolean);
    const associateMatch = approvedAssociates.find((a) => String(a.id) === String(org.referringAssociateUserId || ''));
    ...
    return {
      ...
      referringAssociate: associateMatch
        ...
        : (org.referringAssociateUserId ? `User #${org.referringAssociateUserId}` : ''),
    ...
    <div style={pageWrap}>
      ...
      <div style={activeTab !== 'details' && isEdit ? { display: 'none' } : formGrid}>
        ...
        <FormSection title="Referral &amp; commission">
          <div style={fieldRow}>
            <div style={fieldWrap}>
              <FieldLabel label="Referring associate" />
              {canListAssociates ? (
                <select
                  value={form.referringAssociateUserId}
                  onChange={e => setField('referringAssociateUserId', e.target.value)}
                  style={selectStyle}
                >
                ...
                <p style={{ fontSize: 12, color: '#64748b', margin: 0 }}>
                  Picking an associate requires <strong>Associates</strong> admin permission.
                </p>
              )}
            </div>
            <div style={fieldWrap}>
