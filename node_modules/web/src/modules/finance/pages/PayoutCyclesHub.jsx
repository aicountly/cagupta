...
const PAYOUT_SECTIONS = [
  {
    ...
    description: 'Process and manage payout cycles for associate partners',
    permission: 'associates.manage',
    tools: [
      {
        id: 'associate-payout-cycles',
        label: 'Associate Payout Cycles',
        description: 'Review, approve, and disburse associate commissions. Manage cycle-wise payouts for all associate partners.',
        icon: Handshake,
        to: '/finance/associate-payout-cycles',
      },
    ],
  },
  {
      ...
      <div style={styles.header}>
        ...
        <div>
          ...
          <p style={styles.headerSub}>
            Manage associate and partner payout cycles from one place.
          </p>
        </div>
      </div>
