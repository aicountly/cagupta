...
const CAPTCHA_REQUIRED = Boolean(TURNSTILE_SITE_KEY) && !IS_MOCK;
          ...
          <div style={styles.modal} role="dialog" aria-modal="true" aria-labelledby="cta-modal-title">
            ...
            {done ? (
              ...
              <form onSubmit={handleSubmit} style={styles.form}>
                ...
                <input type="text" name="website" tabIndex={-1} autoComplete="off" style={styles.honeypot} aria-hidden="true" />
                ...
                <TurnstileField
                  siteKey={CAPTCHA_REQUIRED ? TURNSTILE_SITE_KEY : ''}
