...
const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      {
        id: 'associate-tracking',
        label: 'Associate Share & Track',
        description: 'Generate UTM-tagged associate links and monitor referral traffic attribution.',
        icon: Link2,
        to: '/marketing/associate-tracking',
      },
    ],
  },
];
