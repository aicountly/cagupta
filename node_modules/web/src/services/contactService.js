...
function normalizeContact(c) {
  ...
  return {
    ...
    referringAssociateUserId: c.referring_associate_user_id ?? null,
...
export async function createContact(payload) {
  ...
  const body = {
    ...
    referring_associate_user_id: payload.referringAssociateUserId != null && payload.referringAssociateUserId !== ''
      ? Number(payload.referringAssociateUserId) : null,
...
export async function updateContact(id, payload) {
  ...
  if (hasOwn(payload, 'referringAssociateUserId')) {
    const v = payload.referringAssociateUserId;
    body.referring_associate_user_id = v === '' || v == null ? null : Number(v);
  }
