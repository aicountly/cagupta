...
class Routes
{
    ...
    public static function getRoutes(): array
    {
        return [
            ...
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/approvals/associate-payout-cycle-amendments',
                'handler'    => 'Admin\AssociatePayoutCycleAmendmentApprovalController@index',
                'middleware' => ['auth', 'staff', 'role:super_admin'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/approvals/associate-payout-cycle-amendments/:id/approve',
                'handler'    => 'Admin\AssociatePayoutCycleAmendmentApprovalController@approve',
                'middleware' => ['auth', 'staff', 'role:super_admin'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/approvals/associate-payout-cycle-amendments/:id/reject',
                'handler'    => 'Admin\AssociatePayoutCycleAmendmentApprovalController@reject',
                'middleware' => ['auth', 'staff', 'role:super_admin'],
            ],
            // Legacy approval paths (pre-associate rename)
            [
                'method'     => 'GET',
            ...
            // ── Admin — Associates & commissions ─────────────────────────────
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associates',
                'handler'    => 'Admin\AssociateAdminController@index',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PATCH',
                'pattern'    => '/api/admin/associates/:id/approve',
                'handler'    => 'Admin\AssociateAdminController@approve',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PATCH',
                'pattern'    => '/api/admin/associates/:id/suspend',
                'handler'    => 'Admin\AssociateAdminController@suspend',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/commission-defaults',
                'handler'    => 'Admin\AssociateAdminController@commissionDefaults',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PUT',
                'pattern'    => '/api/admin/commission-defaults',
                'handler'    => 'Admin\AssociateAdminController@updateCommissionDefaults',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associates/:id/rates',
                'handler'    => 'Admin\AssociateAdminController@ratesIndex',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/associates/:id/rates',
                'handler'    => 'Admin\AssociateAdminController@ratesStore',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'DELETE',
                'pattern'    => '/api/admin/associate-rates/:id',
                'handler'    => 'Admin\AssociateAdminController@ratesDestroy',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/payout-requests',
                'handler'    => 'Admin\AssociateAdminController@payoutIndex',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PATCH',
                'pattern'    => '/api/admin/payout-requests/:id',
                'handler'    => 'Admin\AssociateAdminController@payoutUpdate',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associate-payout-cycles',
                'handler'    => 'Admin\AssociatePayoutCycleController@index',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/associate-payout-cycles/ensure',
                'handler'    => 'Admin\AssociatePayoutCycleController@ensure',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associate-payout-cycles/:id/preview',
                'handler'    => 'Admin\AssociatePayoutCycleController@preview',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associate-payout-cycles/:id',
                'handler'    => 'Admin\AssociatePayoutCycleController@show',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/associate-payout-cycles/:id/finalise',
                'handler'    => 'Admin\AssociatePayoutCycleController@finalise',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/associate-payout-cycles/:id/disburse',
                'handler'    => 'Admin\AssociatePayoutCycleController@disburse',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/associate-payout-cycles/:id/amendments',
                'handler'    => 'Admin\AssociatePayoutCycleController@submitAmendment',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PATCH',
                'pattern'    => '/api/admin/associate-bank/:id/verify',
                'handler'    => 'Admin\AssociateAdminController@bankVerify',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PATCH',
                'pattern'    => '/api/admin/associates/:id/payout-model',
                'handler'    => 'Admin\AssociateAdminController@setPayoutModel',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associates/:id/active-fee-map',
                'handler'    => 'Admin\AssociateAdminController@activeFeeMapIndex',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/admin/associates/:id/active-fee-map',
                'handler'    => 'Admin\AssociateAdminController@activeFeeMapStore',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'DELETE',
                'pattern'    => '/api/admin/associate-active-fee-map/:id',
                'handler'    => 'Admin\AssociateAdminController@activeFeeMapDestroy',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/admin/associate-redemptions',
                'handler'    => 'Admin\AssociateAdminController@redemptionsIndex',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            [
                'method'     => 'PATCH',
                'pattern'    => '/api/admin/associate-redemptions/:id',
                'handler'    => 'Admin\AssociateAdminController@redemptionsUpdate',
                'middleware' => ['auth', 'staff', 'permission:associates.manage'],
            ],
            ...
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/dashboard',
                'handler'    => 'Associate\AssociatePortalController@dashboard',
                'middleware' => ['auth', 'permission:associate.portal'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/services',
                'handler'    => 'Associate\AssociatePortalController@services',
                'middleware' => ['auth', 'permission:associate.portal'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/commissions',
                'handler'    => 'Associate\AssociatePortalController@commissions',
                'middleware' => ['auth', 'permission:associate.portal'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/statement',
                'handler'    => 'Associate\AssociatePortalController@statement',
                'middleware' => ['auth', 'permission:associate.portal'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/bank',
                'handler'    => 'Associate\AssociatePortalController@bankIndex',
                'middleware' => ['auth', 'permission:associate.bank.manage'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/associate/bank',
                'handler'    => 'Associate\AssociatePortalController@bankStore',
                'middleware' => ['auth', 'permission:associate.bank.manage'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/payout-requests',
                'handler'    => 'Associate\AssociatePortalController@payoutIndex',
                'middleware' => ['auth', 'permission:associate.payouts.request'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/associate/payout-requests',
                'handler'    => 'Associate\AssociatePortalController@payoutStore',
                'middleware' => ['auth', 'permission:associate.payouts.request'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/associate/sub-associates',
                'handler'    => 'Associate\AssociatePortalController@subAffiliateStore',
                'middleware' => ['auth', 'permission:associate.sub_associates.create'],
            ],
            [
                'method'     => 'GET',
                'pattern'    => '/api/associate/rewards',
                'handler'    => 'Associate\AssociatePortalController@rewardsIndex',
                'middleware' => ['auth', 'permission:associate.portal'],
            ],
            [
                'method'     => 'POST',
                'pattern'    => '/api/associate/rewards/redeem',
                'handler'    => 'Associate\AssociatePortalController@rewardsRedeem',
                'middleware' => ['auth', 'permission:associate.portal'],
            ],

            // Legacy affiliate API paths (pre-associate rename)
            [
                'method'     => 'GET',
