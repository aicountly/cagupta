...
SQL;
    ...
    public function paginate(
        ...
        @file_put_contents($__log, json_encode(['sessionId'=>'db20f6','runId'=>'run1','hypothesisId'=>'H1','location'=>'ServiceModel.php:paginate','message'=>'before_count_query','data'=>['whereClause'=>$whereClause,'scopeUidCount'=>substr_count($whereClause,':scope_uid'),'paramKeys'=>array_keys($params)],'timestamp'=>(int)round(microtime(true)*1000)])."\n", FILE_APPEND|LOCK_EX);
        ...
        // #region agent log db20f6
        @file_put_contents($__log, json_encode(['sessionId'=>'db20f6','runId'=>'run1','hypothesisId'=>'H2','location'=>'ServiceModel.php:paginate','message'=>'after_count_query','data'=>['total'=>$total],'timestamp'=>(int)round(microtime(true)*1000)])."\n", FILE_APPEND|LOCK_EX);
        // #endregion agent log db20f6
        ...
        // #region agent log db20f6
        @file_put_contents($__log, json_encode(['sessionId'=>'db20f6','runId'=>'run1','hypothesisId'=>'H2','location'=>'ServiceModel.php:paginate','message'=>'after_main_select','data'=>['rowCount'=>count($rows)],'timestamp'=>(int)round(microtime(true)*1000)])."\n", FILE_APPEND|LOCK_EX);
        // #endregion agent log db20f6
        foreach ($rows as $i => $r) {
