...
(
    'associate',
    'Associate',
    '{"permissions": ["associate.portal","associate.profile","associate.payouts.request","associate.sub_associates.create","associate.bank.manage"]}',
    TRUE
),
(
    'client',
