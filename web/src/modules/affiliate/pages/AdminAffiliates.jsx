    ...
    <div style={pageWrap}>
      ...
      <div style={headerCard}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={iconWrap}><Handshake size={20} color="#F37920" /></div>
          <div>
...
const btnPrimary = { marginTop: 16, padding: '10px 20px', borderRadius: 8, border: 'none', background: '#F37920', color: '#fff', fontWeight: 600, fontSize: 13, cursor: 'pointer', boxShadow: '0 2px 8px rgba(243,121,32,0.2)' };
