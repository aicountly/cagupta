...
import { getAssociateDashboard } from '../services/associatePortalService';
...
export default function AssociateDashboard() {
  ...
  useEffect(() => {
    getAssociateDashboard().then(setData).catch((e) => setErr(e.message || 'Failed to load'));
  }, []);

  return (
    <AssociateLayout title="Dashboard">
