...
import { getAssociateServices } from '../services/associatePortalService';
...
export default function AssociateServices() {
  ...
  useEffect(() => {
    getAssociateServices({ perPage: 100 }).then((r) => setRows(r.rows)).catch((e) => setErr(e.message || 'Failed'));
  }, []);

  return (
    <AssociateLayout title="My services">
