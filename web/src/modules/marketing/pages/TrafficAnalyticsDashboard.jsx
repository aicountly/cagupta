...
function KPICard({ icon, label, value, sub, trend, inverseColor }) {
  const Icon = icon;
  return (
    <div style={s.kpiCard}>
      <div style={s.kpiTop}>
...
export default function TrafficAnalyticsDashboard() {
  ...
  const leadFunnel = leads ? [
    ...
    { name: 'Associate clicks', count: leads.associate_link_click  ?? 0 },
  ] : [];
      ...
      <div style={s.header}>
        <div style={s.headerLeft}>
          ...
          <div>
            ...
            <p style={s.pageSub}>Website traffic across all portals — public site, associatePayoutAmendments, partner &amp; client.</p>
          </div>
        </div>
